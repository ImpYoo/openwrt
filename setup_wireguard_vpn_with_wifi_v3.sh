...
RADIO24=$(echo "$RADIOS" | grep -E 'radio0|phy0' | head -n1)
RADIO5=$(echo "$RADIOS" | grep -E 'radio1|phy1' | head -n1)

[ -n "$RADIO24" ] || { err "No 2.4GHz radio found"; exit 1; }
[ -n "$RADIO5" ] || { err "No 5GHz radio found"; exit 1; }

try uci delete wireless.ap_${NAME_SHORT}_24g
try uci delete wireless.ap_${NAME_SHORT}_5g

uci batch <<EOF
set wireless.ap_${NAME_SHORT}_24g='wifi-iface'
set wireless.ap_${NAME_SHORT}_24g.device='$RADIO24'
set wireless.ap_${NAME_SHORT}_24g.mode='ap'
set wireless.ap_${NAME_SHORT}_24g.network='$VPNLAN'
set wireless.ap_${NAME_SHORT}_24g.ssid='${WIFI_SSID}_2.4G'
set wireless.ap_${NAME_SHORT}_24g.encryption='sae-mixed'
set wireless.ap_${NAME_SHORT}_24g.key='$WIFI_PWD'
set wireless.ap_${NAME_SHORT}_24g.disabled='0'
set wireless.ap_${NAME_SHORT}_24g.isolate='1'
set wireless.ap_${NAME_SHORT}_24g.ieee80211w='1'
set wireless.ap_${NAME_SHORT}_24g.wps_pushbutton='0'

set wireless.ap_${NAME_SHORT}_5g='wifi-iface'
set wireless.ap_${NAME_SHORT}_5g.device='$RADIO5'
set wireless.ap_${NAME_SHORT}_5g.mode='ap'
set wireless.ap_${NAME_SHORT}_5g.network='$VPNLAN'
set wireless.ap_${NAME_SHORT}_5g.ssid='${WIFI_SSID}_5G'
set wireless.ap_${NAME_SHORT}_5g.encryption='sae-mixed'
set wireless.ap_${NAME_SHORT}_5g.key='$WIFI_PWD'
set wireless.ap_${NAME_SHORT}_5g.disabled='0'
set wireless.ap_${NAME_SHORT}_5g.isolate='1'
set wireless.ap_${NAME_SHORT}_5g.ieee80211w='1'
set wireless.ap_${NAME_SHORT}_5g.wps_pushbutton='0'
EOF
